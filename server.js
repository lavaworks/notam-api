...
// Las mismas condiciones para las nubes. Son dos carpetas y no una sola con
// subcarpetas porque cada catálogo se sube y se revisa por separado: mezclarlas
// obligaría a tocar las dos para cambiar una.
app.use("/fotos/nubes", express.static("fotos_nubes", {
  maxAge: "365d", immutable: true, index: false, fallthrough: true,
}));
